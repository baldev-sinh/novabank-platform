...
public class Customer {
  ...
  public static Customer register(
      UserId userId, String firstName, String lastName, LocalDate dateOfBirth, String phone) {
  ...
  public static Customer restore(
      ...
      Instant updatedAt) {
    return new Customer(
        id, userId, firstName, lastName, dateOfBirth, phone, status, createdAt, updatedAt);
  }
